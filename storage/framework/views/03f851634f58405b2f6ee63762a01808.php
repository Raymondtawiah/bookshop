    ...
    <div class="max-w-7xl mx-auto px-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div class="relative opacity-0 translate-x-50 transition-all duration-700 delay-200" data-animate-target>
                <img src="<?php echo e(asset('welcome.jpg')); ?>" alt="About Bookshop" class="rounded-2xl shadow-2xl w-full max-w-md mx-auto">
            </div>
        </div>
    </div>
</section>
...
<?php /**PATH C:\Users\enter\Herd\bookshop\resources\views/components/sections/about-section.blade.php ENDPATH**/ ?>