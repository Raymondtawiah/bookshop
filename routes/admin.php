...
Route::prefix('admin')->name('admin.')->middleware(['auth:web', 'admin'])->group(function () {
    ...
    Route::get('webinars/{webinar}/show', [WebinarController::class, 'show'])->name('webinars.admin.show')->where('webinar', '[0-9]+');
    Route::get('webinars/{webinar}/attendees', [WebinarController::class, 'attendees'])->name('webinars.attendees')->where('webinar', '[0-9]+');
