        ...
        <div class="bg-white rounded-xl shadow-lg p-8">
            ...
            <div class="bg-indigo-50 rounded-lg p-4 mb-6">
                ...
                <p class="text-gray-600">
                    <span class="font-semibold">Session Date & Time:</span> 
            ...
            <!-- Join Button -->
            <div class="text-center mb-6">
                <a href="{{ $meetingLink }}" class="inline-block bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-8 py-3 rounded-lg font-semibold hover:opacity-90">
                    Join Meeting Now
                </a>
            </div>
            ...
            <div class="bg-gray-50 rounded-lg p-4">
                ...
                <a href="{{ $meetingLink }}" class="text-indigo-600 hover:underline text-sm break-all">{{ $meetingLink }}</a>
            </div>
