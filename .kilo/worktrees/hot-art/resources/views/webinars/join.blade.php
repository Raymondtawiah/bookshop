            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                 <div>
                     ...
                     @if($webinar->scheduled_at)
                         <p class="font-medium text-gray-900">{{ $webinar->scheduled_at->timezone('Africa/Accra')->format('F j, Y') }}</p>
                         <p class="text-gray-600">{{ $webinar->scheduled_at->timezone('Africa/Accra')->format('g:i A') }}</p>
                     @else
