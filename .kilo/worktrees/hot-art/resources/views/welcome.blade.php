...
<div class="w-full overflow-x-hidden min-w-0 mx-0 px-0">
         ...
         <!-- Announcement Banner -->
         <div class="pt-14 md:pt-0 bg-gradient-to-r from-green-50 to-emerald-50 border-b border-green-200">
    ...
    <p class="font-bold text-xl text-indigo-600">
        ...
        @include('announcement.anouncement_modal')
        @include('components.visa-chat-widget')
    </div>
    </body>
</html>
