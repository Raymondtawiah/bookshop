...
class OrderPdfService
{
     ...
     */
    public function generateAndSendPdf(Order $order, int $bookId, ?string $overrideEmail = null, ?string $overrideName = null): array
    {
        try {
            ...
            Log::info('PDF sent successfully to '.($overrideEmail ?? $order->email)." for order #{$order->id}");
