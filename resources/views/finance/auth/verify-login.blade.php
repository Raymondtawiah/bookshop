...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Verify Login - Finance - {{ config('app.name', 'Bookshop') }}</title>
    ...
    <body class="bg-gray-50 min-h-screen flex items-center justify-center px-4">
        <div class="w-full max-w-sm">
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
                ...
                <form method="POST" action="{{ route('finance.login.verify') }}" class="space-y-4">
                    @csrf
                    <div>
                ...
                <div class="mt-5 text-center">
                    ...
                    <form method="POST" action="{{ route('finance.login.resend') }}" class="inline">
                        @csrf
                ...
                <div class="mt-5 pt-4 border-t border-gray-100 text-center">
                    <a href="{{ route('finance.login') }}" class="text-sm text-gray-500 hover:text-gray-900">
