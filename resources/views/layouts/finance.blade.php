        ...
        <div class="finance-sidebar-wrapper relative flex min-h-screen">
            ...
            <aside class="finance-sidebar fixed inset-y-0 left-0 w-64 bg-white shadow-2xl" id="financeSidebar">
                ...
                <nav class="px-4 py-4 space-y-1">
                    ...
                    <a href="{{ route('finance.attendance') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium {{ request()->routeIs('finance.attendance') ? 'bg-indigo-50 text-indigo-700' : 'text-gray-600 hover:bg-gray-50' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
