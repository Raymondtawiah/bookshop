        ...
        <flux:sidebar sticky collapsible="mobile" class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:sidebar.nav>
                <flux:sidebar.group :heading="__('Admin Panel')" class="grid">
                    ...
                    <flux:sidebar.item icon="users" :href="route('admin.customers')" :current="request()->routeIs('admin.customers*')" wire:navigate>
                        {{ __('Customers') }}
                    </flux:sidebar.item>
                    <flux:sidebar.item icon="shopping-cart" :href="route('admin.orders')" :current="request()->routeIs('admin.orders*')" wire:navigate>
                        {{ __('Orders') }}
                    </flux:sidebar.item>
                    <flux:sidebar.item icon="calendar-days" :href="route('admin.coachings.index')" :current="request()->routeIs('admin.coachings*')" wire:navigate>
                        {{ __('Coachings') }}
                    </flux:sidebar.item>
                </flux:sidebar.group>
            </flux:sidebar.nav>
        ...
        <flux:header class="lg:hidden">
            ...
            <flux:dropdown position="top" align="end">
                ...
                <flux:menu>
                    ...
                    <flux:menu.radio.group>
                        <flux:menu.item :href="route('admin.settings')" icon="cog" wire:navigate>
                            {{ __('Settings') }}
                        </flux:menu.item>
                    </flux:menu.radio.group>
