    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
            ...
            <div class="flex gap-2">
                <a href="{{ route('admin.webinars.index', ['webinar_id' => $webinar->id]) }}" class="px-4 py-2 text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded-lg transition-colors flex items-center gap-2">
            ...
            <form method="POST" action="{{ route('admin.webinars.notifications.store', $webinar->id) }}" class="space-y-6">
                ...
                <div class="flex flex-col gap-4 pt-6 border-t border-gray-100">
                    ...
                    <div class="text-center">
                        <a href="{{ route('admin.webinars.index', ['webinar_id' => $webinar->id]) }}" class="text-gray-600 hover:text-gray-700 text-sm">
                            Cancel
                        </a>
                    </div>
                </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (typeParam === 'reminder') {
                ...
                if (messageField && !messageField.value) {
                     const webinarDate = '{{ $webinar->scheduled_at ? $webinar->scheduled_at->timezone('Africa/Accra')->format("l, F j, Y \\a\\t g:i A") : "TBA" }}';
