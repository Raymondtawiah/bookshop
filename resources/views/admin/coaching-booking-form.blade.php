            ...
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-8">
                    ...
                    <p class="text-lg text-gray-600">
                        @if($plan === 'team')
                            You've selected the <strong>Team Coaching Plan</strong> - ₵500
                        @elseif($plan === 'single')
                            You've selected the <strong>1 Week Interview Intensive</strong> - ₵1499
                        @elseif($plan === 'premium')
                            You've selected the <strong>Full Coaching Program</strong> - ₵2499
                        @endif
                    </p>
