...
<div class="text-xs text-gray-500 mt-1">
                        ...
                        <td class="px-2 py-3 whitespace-nowrap">
                            <a href="{{ route('admin.orders.show', $order->id) }}" class="inline-flex items-center gap-1.5 text-sm font-bold text-indigo-600 hover:text-indigo-700" title="View Order Details">
