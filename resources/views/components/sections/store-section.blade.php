...
<section id="store" class="py-20 bg-white overflow-hidden" data-animate>
    <div class="max-w-7xl mx-auto px-6">
        <div class="text-center mb-16 opacity-0 translate-y-8 transition-all duration-700" data-animate-target>
            <h2 class="text-4xl font-bold text-gray-900 mb-4">All Books</h2>
         ...
         <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
            @forelse($books as $index => $book)
             <div class="opacity-0 translate-y-8 transition-all duration-700" data-animate-target style="transition-delay: {{ $index * 100 }}ms;">
                @if($book->isFreePdf())
