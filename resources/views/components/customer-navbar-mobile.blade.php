...
<div class="md:hidden flex items-center gap-2">
    ...
    <a href="{{ route('cart') }}" class="relative p-2 text-gray-600 hover:text-indigo-600">
        ...
        @if($mobileCartCount > 0)
            <span class="absolute -top-1 -right-1 bg-indigo-600 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center">{{ $mobileCartCount }}</span>
        @endif
    </a>
    @endauth
...
<div id="customer-mobile-menu" class="hidden absolute top-full left-0 right-0 bg-white shadow-lg border-t border-gray-200 p-4" style="display: none; z-index: 9999 !important;">
